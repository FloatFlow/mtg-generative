...
def parse_args():
    ...
    parser.add_argument('--g_weights',
                        type=str,
                        default='logging/model_saves/minigan_generator_weights_65_0.162.h5')
    parser.add_argument('--d_weights',
                        type=str,
                        default='logging/model_saves/minigan_discriminator_weights_65_4.012.h5')
